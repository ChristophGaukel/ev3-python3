...
def test_opNop(capsys):
    ...
    assert reply_2_str.startswith('04:00:30:00:02:')
    assert len(reply_2_str) == 17
    ...
    assert reply_1_str.startswith('04:00:2F:00:02:')
    assert len(reply_1_str) == 17
